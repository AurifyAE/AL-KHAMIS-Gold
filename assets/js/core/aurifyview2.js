  ...
  try {
    ...
    for (const data of tableData) {
      ...
      setInterval(() => {
        ...
        document.getElementById("silverBidTd").textContent = parseInt(silverBiddingPrice*1000*0.9999);
        document.getElementById("silverAskTd").textContent = parseInt(silverAskingPrice*1000*0.9999);
      ...
      newRow.innerHTML = `
                ...
                <td style="text-align: left; font-size:18px; font-weight: 600;">${purity}</td>
